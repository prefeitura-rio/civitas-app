...
export function ReportDocument({ data, params, ranking }: ReportDocumentProps) {
  ...
  const coverParams = [
    ...
    },
    {
      ...
      value: `De ${format(params.startTime, 'dd/MM/yyyy HH:mm:ss', { locale: ptBR })} até ${format(params.endTime, 'dd/MM/yyyy HH:mm:ss', { locale: ptBR })}`,
    },
    {
  ...
  const getDetectionParams = (data: DetectionGroup) => {
    ...
    return [
      ...
      {
        label: 'Período analisado:',
        value: `De ${format(data.start_time, 'dd/MM/yyyy HH:mm:ss', { locale: ptBR })} até ${format(data.end_time, 'dd/MM/yyyy HH:mm:ss', { locale: ptBR })}`,
      },
      {
        label: 'Radares:',
