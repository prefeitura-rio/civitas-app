  ...
  return (
    <div className={styles.root}>
      <div className={styles.topBar}>
        <span className={styles.topBarTitle}>Converter em Demanda</span>
      </div>
          ...
          {!emailId && (
            <div className={styles.emailInfoSection}>
              <p className={styles.emailBodyText}>
                ...
                Demanda&quot; para carregar o conteúdo aqui.
              </p>
            </div>
          )}
        ...
        <div className={styles.rightPanel}>
                ...
                async (data) => {
                  try {
                    ...
                    if (intent === 'save' || isConvert) {
                      router.push('/demandas/caixa-entrada')
                    } else {
                      setEmailAttachmentSelectedIds(new Set())
          ...
          >
            <div className={styles.rightPanelScroll}>
              <h3 className={styles.rightPanelTitle}>Dados da Demanda</h3>
                                ...
                                return (
                                  ...
                                  >
                                    <button
                                      ...
                                      title={
                                        selected
                                          ? 'Desmarcar para não enviar na demanda'
                                          : 'Marcar para enviar na demanda'
                                      }
                                    >
                                      {selected ? (
                                        <SquareCheck
