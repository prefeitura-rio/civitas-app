...
import { useSpamSearchParams } from '@/hooks/useParams/useSpamSearchParams'
import { type EmailBase, getEmailsSpam } from '@/http/emails/get-emails'
    ...
    <>
      ...
      <div className={inboxStyles.content}>
        <header className={inboxStyles.header}>
          <div>
            <h1 className={inboxStyles.title}>Spam</h1>
            <p className={inboxStyles.subtitle}>
              Listagem de e-mails identificados como spam.
            </p>
          </div>
        </header>
