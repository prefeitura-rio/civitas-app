...
test.describe('Radar Selection Bug with Real Auth', () => {
  test('should allow login and test automatic reselection bug', async ({
    page,
  }) => {
    ...
    const testUrl =
      'http://localhost:3000/veiculos/busca-por-radar?radarIds=0540461121,0540461122&plate=ABC1234&date=%7B%22from%22:%222024-12-01T08:00:00.000Z%22,%22to%22:%222024-12-01T13:00:00.000Z%22%7D'
