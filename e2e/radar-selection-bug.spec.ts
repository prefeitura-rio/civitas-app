...
test.describe('Radar Selection Bug', () => {
  test('should reproduce bug: deselecting all radars should not automatically reselect', async ({
    page,
  }) => {
    ...
    const testUrl =
      'http://localhost:3000/veiculos/busca-por-radar?radarIds=0540461121,0540461122,0540461123&plate=ABC1234&date=%7B%22from%22:%222024-12-01T08:00:00.000Z%22,%22to%22:%222024-12-01T13:00:00.000Z%22%7D'
  ...
  test('deve permitir visualizar a página de resultados e interagir com radares', async ({
    ...
    const testUrl =
      'http://localhost:3000/veiculos/busca-por-radar/resultado?radarIds=0540461121&plate=ABC1234&date=%7B%22from%22:%222024-12-01T08:00:00.000Z%22,%22to%22:%222024-12-01T13:00:00.000Z%22%7D'
    ...
    const possibleElements = page.locator(
      'form, table, .loading, .spinner, button, input, [data-testid*="data"], [class*="search"], [class*="result"]',
    )
